<?php include('ptl-F-E/header.php');?>
        ...
        <main class="l-main">
            ...
            <section class="home" id="home">
                <div class="home__container bd-container bd-grid">
                    <div class="home__data">
                        <h1 class="home__title">Logo food</h1>
            ...
            <section class="menu section bd-container" id="menu">
                ...
                $sql = "SELECT * FROM food WHERE active='yes' AND feature='yes' LIMIT 6";
                    ...
                    <div class="menu__container bd-grid">
                        <div class="menu__content">
                            ...
                            if($image_name==""){
                                ...
                                ?>
                                <img src="<?php echo SITEURL; ?>assets/img/food/<?php echo $image_name;?>" alt="" class="menu__img">
                               
                                <?php
                            }
                            ?>

                        <h3 class="menu__name"><?php echo $title; ?></h3>
                        <span class="menu__detail"><?php echo $description; ?></span>
            ...
            <section class="app section bd-container">
                <div class="app__container bd-grid">
                    ...
                    <img src="assets/img/food-app.png" alt="" class="app__img">
                </div>
            </section>
        ...
        <!--========== FOOTER ==========-->
        <?php include('ptl-F-E/footer.php'); ?>